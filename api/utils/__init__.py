        ...
        FunctionSchema(
            ...
            parameters={
                ...
                "properties": {
                    "location": {
                        "type": "string",
                        "description": "The location to get weather for (e.g., Daejeon, Seoul, Cheonan) (location must be set in ENGLISH ONLY)"
                    },
                    "unit": {
                        "type": "string",
        ...
        FunctionSchema(
            ...
            parameters={
                ...
                "properties": {
                    "location": {
                        "type": "string",
                        "description": "The location to get forecast for (e.g., Daejeon, Seoul, Cheonan) (location must be set in ENGLISH ONLY)"
                    },
                    "days": {
                        "type": "integer",
